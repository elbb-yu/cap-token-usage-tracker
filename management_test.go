...
func TestManagementRegistrationUsesDynamicPluginID(t *testing.T) {
	...
	if len(registration.Routes) != 7 || registration.Routes[0].Method != http.MethodPost || registration.Routes[0].Path != "/plugins/custom-id/full-mode/session" || registration.Routes[1].Path != "/plugins/custom-id/stats" || registration.Routes[3].Method != http.MethodPut || registration.Routes[3].Path != "/plugins/custom-id/prices" || registration.Routes[4].Path != "/plugins/custom-id/prices/sync" || registration.Routes[5].Method != http.MethodGet || registration.Routes[5].Path != "/plugins/custom-id/backup" || registration.Routes[6].Method != http.MethodPost || registration.Routes[6].Path != "/plugins/custom-id/restore" || len(registration.Resources) != 13 || registration.Resources[0].Path != "/dashboard" || registration.Resources[1].Path != "/full-dashboard" || registration.Resources[2].Path != "/full-mode/data" || registration.Resources[3].Path != "/full-mode/session/revoke" || registration.Resources[4].Path != "/full-mode/prices" || registration.Resources[5].Path != "/full-mode/prices/save" || registration.Resources[6].Path != "/full-mode/prices/sync" || registration.Resources[7].Path != "/stats" || registration.Resources[8].Path != "/requests" || registration.Resources[9].Path != "/costs" || registration.Resources[10].Path != "/exchange-rate" || registration.Resources[11].Path != "/prices" || registration.Resources[12].Path != "/preferences" {
